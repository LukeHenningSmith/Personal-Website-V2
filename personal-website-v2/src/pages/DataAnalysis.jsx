      ...
      <div className="flex justify-center items-center h-screen">
        <div className="w-1/2 p-4 flex flex-col justify-center items-center max-w-xl">
          ...
          >
            ...
            popular python libraries of Pandas and Matplotlib. For example, I
            used these libraries to analyse COVID-19 causes in DATA1002 and
            atmospheric chemistry reactions in CHEM3123 where I received a High
            Distinction in both. <br /> A preview of a graph from my most recent
            data investigation into the COVID-19 mortality rate is on the right,
            with the full investigation and source code linked below.
          </h1>
