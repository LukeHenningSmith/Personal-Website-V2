      ...
      <div className="flex justify-center items-center h-screen">
        ...
        <div className="w-1/2 p-4 flex flex-col justify-center items-center max-w-xl">
          ...
          >
            ...
            farmers manage their inventory, staff and sales using an intuitive,
            functional and reliable web interface. The application supports user
            accounts & login, data storage and reactive web pages using the REST
            API architecture style. The project also included deployment to an
            AWS server for university marking. I was involved in all aspects of
            the project including backend Django data models, frontend React
